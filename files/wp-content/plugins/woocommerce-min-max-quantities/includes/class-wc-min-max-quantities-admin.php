	...
	public function write_panel() {
		...
		?><p class="form-field">
			...
			<span class="exclude_checkbox_wrapper">
				...
				<span class="labelspan"><?php esc_html_e( 'Order rules', 'woocommerce-min-max-quantities' ); ?></span><?php echo wc_help_tip( __( 'Exclude this product from order rules (minimim/maximum quantity and value).', 'woocommerce-min-max-quantities' ) ); ?>
			</span>
			<span class="exclude_checkbox_wrapper">
