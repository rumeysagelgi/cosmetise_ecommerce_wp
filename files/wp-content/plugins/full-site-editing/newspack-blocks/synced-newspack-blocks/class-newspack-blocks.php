...
class Newspack_Blocks {
	...
	public static function disable_jetpack_donate() {
		...
		Jetpack_Gutenberg::set_extension_unavailable(
			'jetpack/donations',
			esc_html__( 'Jetpack donations is disabled in favour of Newspack donations.', 'full-site-editing' )
		);
	}
