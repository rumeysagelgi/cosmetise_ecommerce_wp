...
/* harmony export */   rH: () => (/* binding */ INSTALL_PLUGIN)
/* harmony export */ });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   w: () => (/* binding */ withAnalytics)
/* harmony export */ });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LH: () => (/* binding */ fetchAutomatedTransferStatus),
/* harmony export */   WJ: () => (/* binding */ setAutomatedTransferStatus),
/* harmony export */   rv: () => (/* binding */ updateEligibility),
/* harmony export */   yX: () => (/* binding */ automatedTransferStatusFetchingFailure)
/* harmony export */ });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   p: () => (/* binding */ transferStates),
/* harmony export */   t: () => (/* binding */ eligibilityHolds)
/* harmony export */ });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,calypso_state_utils__WEBPACK_IMPORTED_MODULE_1__/* .withPersistence */ .$)(function () {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   x2: () => (/* binding */ eligibility)
/* harmony export */ });
...
const status = (0,calypso_state_utils__WEBPACK_IMPORTED_MODULE_1__/* .withPersistence */ .$)(function () {
  ...
  switch (action.type) {
    case calypso_state_action_types__WEBPACK_IMPORTED_MODULE_2__/* .AUTOMATED_TRANSFER_ELIGIBILITY_UPDATE */ .zGH:
      return state || _constants__WEBPACK_IMPORTED_MODULE_3__/* .transferStates.INQUIRING */ .p.INQUIRING;
    case calypso_state_themes_action_types__WEBPACK_IMPORTED_MODULE_4__/* .THEME_TRANSFER_INITIATE_REQUEST */ .LG:
      return _constants__WEBPACK_IMPORTED_MODULE_3__/* .transferStates.START */ .p.START;
    case calypso_state_themes_action_types__WEBPACK_IMPORTED_MODULE_4__/* .THEME_TRANSFER_INITIATE_FAILURE */ .aB:
      return _constants__WEBPACK_IMPORTED_MODULE_3__/* .transferStates.FAILURE */ .p.FAILURE;
    ...
    case calypso_state_themes_action_types__WEBPACK_IMPORTED_MODULE_4__/* .THEME_TRANSFER_STATUS_RECEIVE */ .rV:
      return 'complete' === action.status ? _constants__WEBPACK_IMPORTED_MODULE_3__/* .transferStates.COMPLETE */ .p.COMPLETE : state;
    case calypso_state_action_types__WEBPACK_IMPORTED_MODULE_2__/* .AUTOMATED_TRANSFER_STATUS_REQUEST_FAILURE */ .Sdq:
      ...
      return action.error === 'An invalid transfer ID was passed.' ? _constants__WEBPACK_IMPORTED_MODULE_3__/* .transferStates.NONE */ .p.NONE : _constants__WEBPACK_IMPORTED_MODULE_3__/* .transferStates.REQUEST_FAILURE */ .p.REQUEST_FAILURE;
  }
  return state;
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (automatedTransferReducer);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   YJ: () => (/* binding */ automatedTransfer)
/* harmony export */ });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   t: () => (/* binding */ getAutomatedTransfer)
/* harmony export */ });
 ...
 */
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((state, siteId) => {
  if (!siteId) {
    return null;
  }
 ...
 */
const statusMapping = {
  blocked_atomic_transfer: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.BLOCKED_ATOMIC_TRANSFER */ .t.BLOCKED_ATOMIC_TRANSFER,
  transfer_already_exists: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.TRANSFER_ALREADY_EXISTS */ .t.TRANSFER_ALREADY_EXISTS,
  no_business_plan: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.NO_BUSINESS_PLAN */ .t.NO_BUSINESS_PLAN,
  no_jetpack_sites: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.NO_JETPACK_SITES */ .t.NO_JETPACK_SITES,
  no_vip_sites: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.NO_VIP_SITES */ .t.NO_VIP_SITES,
  site_private: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.SITE_PRIVATE */ .t.SITE_PRIVATE,
  //site_private: eligibilityHolds.SITE_UNLAUNCHED, // modified in eligibilityHoldsFromApi
  site_graylisted: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.SITE_GRAYLISTED */ .t.SITE_GRAYLISTED,
  non_admin_user: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.NON_ADMIN_USER */ .t.NON_ADMIN_USER,
  not_resolving_to_wpcom: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.NOT_RESOLVING_TO_WPCOM */ .t.NOT_RESOLVING_TO_WPCOM,
  no_ssl_certificate: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.NO_SSL_CERTIFICATE */ .t.NO_SSL_CERTIFICATE,
  email_unverified: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.EMAIL_UNVERIFIED */ .t.EMAIL_UNVERIFIED,
  excessive_disk_space: calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.EXCESSIVE_DISK_SPACE */ .t.EXCESSIVE_DISK_SPACE
};
...
const eligibilityHoldsFromApi = function (_ref) {
  ...
  return errors.map(_ref2 => {
    ...
    if (options.sitePrivateUnlaunched && code === 'site_private') {
      return calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_4__/* .eligibilityHolds.SITE_UNLAUNCHED */ .t.SITE_UNLAUNCHED;
    }
...
const receiveStatus = (_ref, _ref2) => {
  ...
  return dispatch => {
    ...
    if (status !== calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_6__/* .transferStates.ERROR */ .p.ERROR && status !== calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_6__/* .transferStates.COMPLETE */ .p.COMPLETE) {
    ...
    if (status === calypso_state_automated_transfer_constants__WEBPACK_IMPORTED_MODULE_6__/* .transferStates.COMPLETE */ .p.COMPLETE) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fetchAutomatedTransferStatusForSelectedSite: () => (/* binding */ fetchAutomatedTransferStatusForSelectedSite)
/* harmony export */ });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,calypso_state_utils__WEBPACK_IMPORTED_MODULE_5__/* .combineReducers */ .U)({
  isRequesting,
  isRequestingAll,
  requestError,
  plugins,
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Q: () => (/* binding */ pluginsSchema)
/* harmony export */ });
const pluginsSchema = {
  type: 'object',
  patternProperties: {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Gb: () => (/* binding */ PLUGIN_INSTALLATION_UP_TO_DATE),
/* harmony export */   gm: () => (/* binding */ PLUGIN_INSTALLATION_IN_PROGRESS),
/* harmony export */   m: () => (/* binding */ PLUGIN_INSTALLATION_ERROR),
/* harmony export */   s1: () => (/* binding */ PLUGIN_INSTALLATION_COMPLETED)
/* harmony export */ });
/**
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   m: () => (/* binding */ pluginInstructionSchema)
/* harmony export */ });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_automattic_state_utils__WEBPACK_IMPORTED_MODULE_0__/* .withStorageKey */ .xi)('plugins', combinedReducer));
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ZN: () => (/* binding */ completePluginUpload),
/* harmony export */   oZ: () => (/* binding */ updatePluginUploadProgress),
/* harmony export */   y9: () => (/* binding */ pluginUploadError)
/* harmony export */ });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,calypso_state_utils__WEBPACK_IMPORTED_MODULE_2__/* .combineReducers */ .U)({
  uploadedPluginId,
  uploadError,
  progressPercent,
  inProgress
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ isSiteAutomatedTransfer)
/* harmony export */ });
/**
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ isUnlaunchedSite)
/* harmony export */ });
