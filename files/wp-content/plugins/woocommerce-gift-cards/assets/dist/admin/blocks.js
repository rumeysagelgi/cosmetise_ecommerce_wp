...
var balance_checkbox_BalanceCheckbox = function BalanceCheckbox(_ref) {
  ...
  var checkboxLabel = Object(external_wp_element_["useMemo"])(function () {
    var label = Object(external_wp_i18n_["sprintf"])( /* translators: %S gift cards balance amount */
    ...
    var pendingOrdersLink = '<a href="' + accountOrdersLink + '">' +
    // TODO: Add link.
    Object(external_wp_i18n_["__"])('pending orders', 'woocommerce-gift-cards') + '</a>';
    var pendingText = Object(external_wp_i18n_["sprintf"])( /* translators: %1$s pending balance, %2$s pending orders link html */
...
var removable_chip_RemovableChip = function RemovableChip(_ref) {
  ...
  if (!ariaLabel) {
    ...
    Object(external_wp_i18n_["__"])('Remove', 'woocommerce-gift-cards') : Object(external_wp_i18n_["sprintf"])( /* translators: %s text of the chip to remove. */
...
var applied_gift_card_AppliedGiftCard = function AppliedGiftCard(_ref) {
  ...
  return Object(external_wp_element_["createElement"])(external_wc_blocksCheckout_["TotalsWrapper"], null, Object(external_wp_element_["createElement"])(external_wc_blocksCheckout_["TotalsItem"], {
    ...
    description: Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, Object(external_wp_element_["createElement"])(removable_chip, {
      ...
      element: "div",
      radius: "large",
      screenReaderText: Object(external_wp_i18n_["sprintf"])( /* translators: %s Gift card code. */
      ...
      ariaLabel: Object(external_wp_i18n_["sprintf"])( /* translators: %s gift card code. */
...
var external_wp_blockEditor_ = __webpack_require__(27);
...
const tag = Object(external_wp_element_["createElement"])(external_wp_primitives_["SVG"], {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, Object(external_wp_element_["createElement"])(external_wp_primitives_["Path"], {
...
var external_wp_blocks_ = __webpack_require__(31);
...
var edit_Edit = function Edit(_ref) {
  ...
  return Object(external_wp_element_["createElement"])("div", blockProps, Object(external_wp_element_["createElement"])(external_wp_components_["Disabled"], null, Object(external_wp_element_["createElement"])(block["a" /* default */], extends_default()({
    className: className
  }, props))));
};
var edit_Save = function Save() {
  return Object(external_wp_element_["createElement"])("div", external_wp_blockEditor_["useBlockProps"].save());
};
var edit_registerInnerBlock = function registerInnerBlock() {
  // Register Block in the Editor.
  Object(external_wp_blocks_["registerBlockType"])(checkout_order_summary_gift_card_form_block.name, _objectSpread(_objectSpread({}, checkout_order_summary_gift_card_form_block), {}, {
    icon: {
      src: Object(external_wp_element_["createElement"])(icon["a" /* default */], {
        icon: library_tag,
...
var checkout_order_summary_gift_card_totals_edit_Edit = function Edit(_ref) {
  var attributes = _ref.attributes;
  var className = attributes.className;
  var blockProps = Object(external_wp_blockEditor_["useBlockProps"])();
  ...
  return Object(external_wp_element_["createElement"])("div", blockProps, Object(external_wp_element_["createElement"])(external_wp_components_["Disabled"], null, Object(external_wp_element_["createElement"])(checkout_order_summary_gift_card_totals_block["a" /* default */], extends_default()({
    className: className
  }, props))));
};
var checkout_order_summary_gift_card_totals_edit_Save = function Save() {
  return Object(external_wp_element_["createElement"])("div", external_wp_blockEditor_["useBlockProps"].save());
};
var checkout_order_summary_gift_card_totals_edit_registerInnerBlock = function registerInnerBlock() {
  // Register Block in the Editor.
  Object(external_wp_blocks_["registerBlockType"])(inner_blocks_checkout_order_summary_gift_card_totals_block.name, edit_objectSpread(edit_objectSpread({}, inner_blocks_checkout_order_summary_gift_card_totals_block), {}, {
    icon: {
      src: Object(external_wp_element_["createElement"])(icon["a" /* default */], {
    ...
    edit: checkout_order_summary_gift_card_totals_edit_Edit,
    save: checkout_order_summary_gift_card_totals_edit_Save
  }));
};
...
function cart_order_summary_gift_card_form_edit_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function cart_order_summary_gift_card_form_edit_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? cart_order_summary_gift_card_form_edit_ownKeys(Object(source), !0).forEach(function (key) { defineProperty_default()(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : cart_order_summary_gift_card_form_edit_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
/**
 * External dependencies
 */
...
var cart_order_summary_gift_card_form_edit_Edit = function Edit(_ref) {
  var attributes = _ref.attributes;
  var className = attributes.className;
  var blockProps = Object(external_wp_blockEditor_["useBlockProps"])();
  ...
  return Object(external_wp_element_["createElement"])("div", blockProps, Object(external_wp_element_["createElement"])(external_wp_components_["Disabled"], null, Object(external_wp_element_["createElement"])(cart_order_summary_gift_card_form_block["a" /* default */], extends_default()({
    className: className
  }, props))));
};
var cart_order_summary_gift_card_form_edit_Save = function Save() {
  return Object(external_wp_element_["createElement"])("div", external_wp_blockEditor_["useBlockProps"].save());
};
var cart_order_summary_gift_card_form_edit_registerInnerBlock = function registerInnerBlock() {
  // Register Block in the Editor.
  Object(external_wp_blocks_["registerBlockType"])(inner_blocks_cart_order_summary_gift_card_form_block.name, cart_order_summary_gift_card_form_edit_objectSpread(cart_order_summary_gift_card_form_edit_objectSpread({}, inner_blocks_cart_order_summary_gift_card_form_block), {}, {
    icon: {
      src: Object(external_wp_element_["createElement"])(icon["a" /* default */], {
        icon: library_tag,
        className: "wc-block-editor-components-block-icon"
...
function cart_order_summary_gift_card_totals_edit_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function cart_order_summary_gift_card_totals_edit_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? cart_order_summary_gift_card_totals_edit_ownKeys(Object(source), !0).forEach(function (key) { defineProperty_default()(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : cart_order_summary_gift_card_totals_edit_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
/**
 * External dependencies
 */
...
var cart_order_summary_gift_card_totals_edit_Edit = function Edit(_ref) {
  var attributes = _ref.attributes;
  var className = attributes.className;
  var blockProps = Object(external_wp_blockEditor_["useBlockProps"])();
  var props = {
  ...
  return Object(external_wp_element_["createElement"])("div", blockProps, Object(external_wp_element_["createElement"])(external_wp_components_["Disabled"], null, Object(external_wp_element_["createElement"])(cart_order_summary_gift_card_totals_block["a" /* default */], extends_default()({
    className: className
  }, props))));
};
var cart_order_summary_gift_card_totals_edit_Save = function Save() {
  return Object(external_wp_element_["createElement"])("div", external_wp_blockEditor_["useBlockProps"].save());
};
var cart_order_summary_gift_card_totals_edit_registerInnerBlock = function registerInnerBlock() {
  // Register Block in the Editor.
  Object(external_wp_blocks_["registerBlockType"])(inner_blocks_cart_order_summary_gift_card_totals_block.name, cart_order_summary_gift_card_totals_edit_objectSpread(cart_order_summary_gift_card_totals_edit_objectSpread({}, inner_blocks_cart_order_summary_gift_card_totals_block), {}, {
    icon: {
      src: Object(external_wp_element_["createElement"])(icon["a" /* default */], {
        icon: library_percent,
        className: "wc-block-editor-components-block-icon"
...
var blocks_registerInnerBlocks = function registerInnerBlocks() {
  ...
  checkout_order_summary_gift_card_totals_edit_registerInnerBlock();
  if (!isCartDisabled) {
