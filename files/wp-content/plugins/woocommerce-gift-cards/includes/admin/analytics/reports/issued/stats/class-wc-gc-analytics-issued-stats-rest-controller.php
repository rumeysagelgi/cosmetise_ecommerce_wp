...
/**
 * WC_GC_Analytics_Issued_Stats_REST_Controller class.
 *
 * @version 1.16.0
 */
class WC_GC_Analytics_Issued_Stats_REST_Controller extends WC_REST_Reports_Controller {
	 ...
	 * @var string
	 */
	protected $rest_base = 'reports/giftcards-issued/stats';
	...
	public function get_items( $request ) {
		...
		$query = new WC_GC_Analytics_Issued_Stats_Query( $query_args );
		try {
	...
	public function prepare_item_for_response( $report, $request ) {
		 ...
		 */
		return apply_filters( 'woocommerce_rest_prepare_report_giftcards_issued_stats', $response, $report, $request );
	}
	...
	public function get_item_schema() {
		...
		$schema = array(
			...
			'title'      => 'report_giftcards_issued_stats',
			'type'       => 'object',
			'properties' => array(
				'totals'    => array(
	...
	public function set_default_report_data( $results ) {
		if ( empty( $results ) ) {
			...
			$results->totals->issued_balance     = 0;
