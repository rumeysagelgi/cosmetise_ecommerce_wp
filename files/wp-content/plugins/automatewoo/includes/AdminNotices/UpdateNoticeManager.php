...
class UpdateNoticeManager {
	...
	public static function output_admin_notice() {
		$title       = __( 'Thanks for updating to AutomateWoo 6.0.0!', 'automatewoo' );
		$description = sprintf(
			__(
				'In this release we deprecated the usage of Cron class and we rely fully on Action Scheduler.
				If you\'re extending AutomateWoo functionality, it\'s discouraged to use AutomateWoo Cron Workers for
				hooking your recurrent actions. Instead we recommend to use AutomateWoo\Jobs\AbstractActionSchedulerJob',
				'automatewoo'
			),
