...
import './report-table.scss'; // `./style.scss` is not included imported for some reason.

// import { STORE_KEY as CES_STORE_KEY } from '../../../customer-effort-score-tracks/data/constants';
const CES_STORE_KEY = 'wc/customer-effort-score';
...
const ReportTable = ( props ) => {
	...
	return (
		<Fragment>
			<div
				className="woocommerce-report-table__scroll-point automatewoo-clone"
				ref={ scrollPointRef }
				aria-hidden
			/>
			<TableCard
...
ReportTable.propTypes = {
	/**
	 * Class list to apply to the HTML element.
	 */
	...
	/**
	 * Set to `true` to force rendering checkboxes (even if `compareBy` is not set).
	 */
	checkboxes: PropTypes.bool,
	/**
	 * Function to render a custom action button. Called with `{ selectedRows }` as the argument.
	 */
